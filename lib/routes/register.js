...
var Register = /** @class */ (function () {
    ...
    Register.prototype.processRequest = function () {
        var _this = this;
        // Initialize status
        var fail_reason = "";
        var pass_fail = true;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, init_1.db.query("INSERT INTO users (username, email, password, image, joined) VALUES (?, ?, ?, ?, ?);", [username, email, hashed_pass, image, this.joined])];
                    case 2:
