...
var Register = /** @class */ (function () {
    ...
    Register.prototype.createAccount = function (username, email, password, image) {
        return __awaiter(this, void 0, void 0, function () {
            var fail_reason, pass_fail, query_response, hash_pass_data, pass_result, hashed_pass, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fail_reason = "";
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, init_1.db.query("INSERT INTO users (username, email, password, image, joined) VALUES (?, ?, ?, ?, ?);", [username, email, hashed_pass, "http://127.0.0.1:81/files/" + encodeURIComponent(image), this.joined])];
                    case 2:
                        query_response = _a.sent();
                        return [3 /*break*/, 5];
                    case 3:
                        if (!(pass_fail !== false)) return [3 /*break*/, 5];
                        return [4 /*yield*/, init_1.db.query("INSERT INTO users (username, email, password, joined) VALUES (?, ?, ?, ?);", [username, email, hashed_pass, this.joined])];
                    case 4:
                        query_response = _a.sent();
                        _a.label = 5;
                    case 5:
