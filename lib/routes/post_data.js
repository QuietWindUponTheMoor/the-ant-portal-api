...
var PostData = /** @class */ (function () {
    ...
    PostData.prototype.processPostData = function () {
        ...
        this.handler._res("/fetch_post_data", function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var post_data, answers_data, data, login_status, post_id, fetch_check, fetch_successful, fetch_fail_reason, answers_check, answers_successful, answers_fail_reason, increment_check, increment_successful, increment_fail_reason, reply_data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.fetchAnswersData(post_id)];
                    case 4:
                        answers_check = _a.sent();
                        answers_successful = answers_check.validated;
                        answers_fail_reason = answers_check.reason;
                        ...
                        _a.label = 5;
                    case 5: return [4 /*yield*/, this.incrementViewCount(post_id)];
                    case 6:
    ...
    PostData.prototype.incrementViewCount = function (post_id) {
        return __awaiter(this, void 0, void 0, function () {
            var fail_reason, pass_fail, post_data, view_count, query_response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fail_reason = "";
                        ...
                        */
                        if (query_response !== null && query_response[0] !== undefined) { // Everything was good up until now
                            if (query_response[0].serverStatus !== 2) { // Query itself failed
                                pass_fail = false;
                                fail_reason = "Query Failed: ".concat(query_response[0].info);
                            }
                            else {
    ...
    PostData.prototype.fetchAnswersData = function (post_id) {
        return __awaiter(this, void 0, void 0, function () {
            var fail_reason, pass_fail, answer_data, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        fail_reason = "";
                        pass_fail = true;
                        return [4 /*yield*/, init_1.db.query("SELECT *, (upvotes - downvotes) AS total_votes, isAcceptedAnswer FROM answers WHERE forPostID=? ORDER BY isAcceptedAnswer DESC, total_votes DESC;", [post_id])];
                    case 1:
                        data = _a.sent();
                        if (data[0].length < 1) {
                            pass_fail = false;
